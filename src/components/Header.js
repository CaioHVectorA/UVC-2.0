    ...
    return (
        <header style={{display: 'flex',justifyContent:'space-between',width:'100%',padding:'0px',backgroundColor:'#B140A6',alignItems: 'center',maxHeight: '82px',paddingRight: mobile ? '24px' : '0px'}}>
            ...
            {Menu && <ul ref={lista} className="sliderleft" style={{display: mobile ? 'flex' : 'none',gap: '22px',flexDirection: 'column',position:'absolute',right:'0px',top: '70px',background: '#6e2367',width: '0%',height: 'calc(100% - 80px)',overflow: 'hidden'}}>
               <a href="#" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela',padding: '1rem 0',textAlign: 'end',margin: '0 1rem',borderBottom: '2px solid rgba(0,0,0,0.1)'}}><li style={{fontSize: '32px',color: 'white',fontFamily: 'Gabriela'}}>Contos</li> </a>
               ...
               <a href="#" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela',padding: '1rem 0',textAlign: 'end',margin: '0 1rem',borderBottom: '2px solid rgba(0,0,0,0.1)'}}><li style={{fontSize: '32px',color: 'white',fontFamily: 'Gabriela'}}>Contato</li> </a>
               <a href="#" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela',padding: '1rem 0',textAlign: 'end',margin: '0 1rem',borderBottom: '2px solid rgba(0,0,0,0.1)'}}><li style={{fontSize: '32px',color: 'white',fontFamily: 'Gabriela'}}>Doação</li> </a>
            </ul>}
        </header>
    )
}
