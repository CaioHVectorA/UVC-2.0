    ...
    return (
        <header style={{display: 'flex',maxWidth: '1800px',margin: '0 auto',justifyContent:'space-between',width:'100%',padding:'0px',backgroundColor:cor[0],alignItems: 'center',maxHeight: '82px',paddingRight: mobile ? '24px' : '0px'}}>
            ...
            {!mobile && <ul style={{marginRight: '3%',display: 'flex',gap: '22px'}}>
               <Link to="/Home" href="#" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela'}}><li style={{fontSize: '32px',color: 'white',fontFamily: 'Gabriela'}}>Contos</li> </Link>
               <Link to="/Personagens" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela'}}><li style={{fontSize: '32px',color: 'white',fontFamily: 'Gabriela'}}>Personagens</li> </Link>
               <div>
               <Link to="/Personalizar" href="#" className="scale" style={{textDecoration: 'none',fontFamily: 'Gabriela',position: 'relative'}}><MenuConfig onMouseOver={HandleOver} onMouseLeave={HandleLeave}>Outros</MenuConfig></Link>
               ...
               <Search placeholder="Telecinese..."></Search>
               <div style={{backgroundColor: '#d9d9d9',borderRadius: '0px 25px 25px 0px',height: '100%',cursor: 'pointer',border: 'none',display: 'grid',placeItems: 'center'}}>
            ...
            {Menu && <ul ref={lista} className="sliderleft" style={{display: mobile ? 'flex' : 'none',gap: '22px',flexDirection: 'column',position:'absolute',right:'0px',top: '82px',background: '#6e2367',width: '0%',height: 'calc(100% - 70px)',overflow: 'hidden'}}>
              <Link to="/Home" style={{textAlign: 'end',marginTop: '12px'}}><MenuItem>Contos</MenuItem></Link>
              <Link to="" style={{textAlign: 'end'}}><MenuItem>Personagens</MenuItem></Link>
