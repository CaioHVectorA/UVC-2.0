    ...
    //     const img = Args[4]
        return (
            ...
            <div style={{height: '245px',background: '#131313',width: '300px',padding: '20px 0px',display: 'grid',justifyContent: 'center',marginBottom: '100px'}}>
             ...
             <h2 style={{color: '#e7e7e7',fontFamily: 'Roboto Slab',fontWeight: 'normal',margin: '0 auto',bottom: '80px',height: 'max-content'}}>{nome}</h2>
...
const DivHists = () => {
  ...
  return (
        ...
        {AllContos.map(({nome,local,tipo,desc,img}) => (
